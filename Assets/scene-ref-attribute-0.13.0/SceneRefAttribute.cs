...
namespace KBCore.Refs
{
    ...
    [AttributeUsage(AttributeTargets.Field)]
    public class SearchByNameAttribute : SceneRefAttribute
    {
        public SearchByNameAttribute(Flag flags = Flag.None, Type filter = null)
            : base(RefLoc.SearchByName, flags, filter)
        {
        }
    }
