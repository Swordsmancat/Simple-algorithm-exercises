    ...
    public static class SceneRefAttributeValidator
    {
        ...
        )
        {
            ...
            switch (attr.Loc)
            {
                ...
                case RefLoc.SearchByName:
                    value = (object)GetComponentByName(component, elementType, field.Name);
                    break;
                default:
        ...
        private static Component GetComponentByName(Component c, Type elementType, string name)
        {
            var transform = c.transform;

            var child = FindChildByName(transform, name);
            if (child != null)
            {
                var component = child.GetComponent(elementType);
                if (component != null)
                    return component;
            }
            return null;
        ...
        private static Transform FindChildByName(Transform transform, string name)
        {
            if (transform == null)
            {
                return null;
